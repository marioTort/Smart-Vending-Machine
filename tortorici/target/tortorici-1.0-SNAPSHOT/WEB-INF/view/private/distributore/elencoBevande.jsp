...
<div class="container my-5 text-center border border-1 rounded-3" id="container_grande">
    ...
    <h1 class="mx-auto">Seleziona una bevanda</h1>
                ...
                <button type="button" name="prodotto" id="${prodotto.idProdotto}" value="${prodotto.idProdotto}" class="btn w-100 mb-1" data-bs-toggle="modal" data-bs-target="#modal-associazione${prodotto.idProdotto}"
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="container my-4 mx-auto" style="max-width: 200px">
                            ...
                            <img src="${pageContext.request.contextPath}/img/distributore/bevande/${prodotto.idProdotto}.svg"
                                 class="card-img-top">
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row mb-2 mx-0 range">

                                    <label for="zucchero" class="form-label">Quantità zucchero</label>

                                    <input type="range" id="zucchero" class="form-range" min="0" max="5" steps="1" value="0">
